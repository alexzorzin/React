const products =
    [
        { id: 1, name: 'Nike AirForce One', size: 8, price: 16999, img:'https://www.courir.es/dw/image/v2/BCCL_PRD/on/demandware.static/-/Sites-master-catalog-courir/default/dw26559699/images/hi-res/001488854_101.png?sw=600&sh=600&sm=fit' },
        { id: 2, name: 'Nike Court Vision Low', size: 7.5, price: 11000, img: 'https://http2.mlstatic.com/D_NQ_NP_812575-MLA40853945365_022020-O.webp' },
        { id: 3, name: 'Adidas Advantage', size: 9, price: 9199, img: 'https://http2.mlstatic.com/D_NQ_NP_667341-MLA48011270907_102021-O.webp' },
        { id: 4, name: 'Puma Electron E', size: 9, price: 9599, img: 'https://http2.mlstatic.com/D_NQ_NP_792759-MLA47957265972_102021-O.webp' },
...
export const Item = new Promise((resolved, rejected) => {
    setTimeout(() => {
        resolved(products)
    }, 2000);
})
